...
function generateRandom(password = '', path = constants_js_1.TRON_BIP39_PATH_INDEX_0, wordlist) {
...
function generateAccountWithMnemonic(mnemonic, path = constants_js_1.TRON_BIP39_PATH_INDEX_0, password = '', wordlist = null) {
