...
import { ethersHDNodeWallet, Mnemonic } from './ethersUtils.js';
...
export function generateRandom(password = '', path = TRON_BIP39_PATH_INDEX_0, wordlist) {
...
export function generateAccountWithMnemonic(mnemonic, path = TRON_BIP39_PATH_INDEX_0, password = '', wordlist = null) {
